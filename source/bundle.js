...
DrawCurve.prototype = {
	...
	endInteractionAndDrawTree : function() {
		...
		var unitLine = _.map(line, function toUnitVector( vec2 ) {
			return [
				vec2.x / canvas.width,
...
},{"../dependancies/Vector2":1,"./utils/hsl-to-fillstyle":6}],3:[function(require,module,exports){
...
},{"./scene":5}],4:[function(require,module,exports){
var Vector2 = require('../dependancies/Vector2')
...
},{"../dependancies/Vector2":1}],5:[function(require,module,exports){
...
Scene.prototype = {
	...
	onNewCurve : function( line ) {
		var i, lineNode
		
		this.settings.unitLine = line
	...
	draw : function() {
		...
		if( this.settings.unitLine ) {
			
			var lines = _.map( this.settings.unitLine, function( line ) {
			
				return new Vector2(
					line[0] * this.canvas.width,
					line[1] * this.canvas.height
				)
...
},{"../dependancies/Vector2":1,"./draw-curve":2,"./line-node":4,"./utils/hsl-to-fillstyle":6,"./utils/rgb-to-fillstyle":7}],6:[function(require,module,exports){
